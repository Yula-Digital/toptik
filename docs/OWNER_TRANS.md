...
- **נשאר פתוח:** `toptik-whatsapp-agent-prod` (הסוכן וואטסאפ) עדיין ב-org של rordan —
  להעביר באותו תהליך אם רוצים בעלות מלאה גם עליו; הפרויקט הריק "toptik2026's Project"
  בחשבון הלקוח — כדאי למחוק (org חינמי מוגבל ל-2 פרויקטים פעילים).
