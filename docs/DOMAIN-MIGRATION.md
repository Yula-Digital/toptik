# העברת הדומיין toptik.co.il — בוצע ✅

> **סטטוס: הושלם ב‑2026-06-18.** הפרודקשן חי על **`https://toptik.co.il`** (ו‑`www` מפנה אליו).
> המסמך הזה הוא **תיעוד מה שבוצע + מדריך תפעול שוטף ו‑rollback** עבור הדומיין החי.
